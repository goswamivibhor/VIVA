...
public class SplashScreenActivity extends AppCompatActivity {
    ...
    boolean mInternetPermission = false;
    ...
    protected void onResume() {
        ...
        if (mInternetPermission) {
            tvSplashScreenInfo.setVisibility(View.VISIBLE);
            VivaHandler.getInstance().initialize(SplashScreenActivity.this);
        } else {
            ActivityCompat.requestPermissions(this, new String[] { Manifest.permission.INTERNET }, REQ_INTERNET_PERMISSION);
        }
    }
